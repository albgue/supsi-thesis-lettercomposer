...
function drawRotateGuidelines(object) {
    ...
    var XYstart = fabric.util.transformPoint(new fabric.Point((object.left-((object.width * scale)/2)), (object.top)), canvas.viewportTransform)
    cp = object.getCenterPoint()
    //console.log("cp.x: " + cp.x * scale)
    var XYmid = fabric.util.transformPoint(new fabric.Point((cp.x), (cp.y)), canvas.viewportTransform)
    var XYend = fabric.util.transformPoint(new fabric.Point((object.left+((object.width * scale)/2)), (object.top)), canvas.viewportTransform)
    ...
    XYstart = fabric.util.transformPoint(new fabric.Point((object.left-((object.height * scale)/2)), (object.top)), canvas.viewportTransform)
    XYend = fabric.util.transformPoint(new fabric.Point((object.left+((object.height * scale)/2)), (object.top)), canvas.viewportTransform)      
    contextLines.save()
